...
class LocalPluginMocker(object):
    ...
    def robot_mapping():
        ...
        #time.sleep(1)
        logging.info("mapping finished, cost 5 seconds")
        global robot_mapping_status
        robot_mapping_status = "started"
        return "success"
    ...
    def get_function(name: str):
        return {
            ...
            "robot_mapping": LocalPluginMocker.robot_mapping,
...
if __name__ == "__main__":
    ...
    mock_input_file = os.path.join(os.path.dirname(__file__), "test_data/input_mapping.json")
